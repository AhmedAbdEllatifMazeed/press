...
class Ansible:
    def __init__(self, server, playbook, user="root", variables=None, port=22):
        ...
        self._log_step(
            "info",
            "Configured Ansible CLI arguments for host %s",
            self.host,
        )
        ...
        self._log_step("info", "Patched Ansible callback and display for playbook %s", self.playbook)
    ...
    def patch(self):
        ...
        self._log_step("info", "Patched Ansible async handlers for playbook %s", self.playbook)
