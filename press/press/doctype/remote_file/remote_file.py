...
def poll_file_statuses_from_bucket(bucket):
    ...
    remote_file_paths = {file["file_path"] for file in remote_files}
...
def delete_remote_backup_objects(remote_files):
    ...
    for file_path, bucket in frappe.db.get_values(
        ...
        buckets[bucket].append(file_path)
